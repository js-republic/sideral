...
var _Engine = require("./../../src/Engine");

var _Engine2 = _interopRequireDefault(_Engine);

var _Component2 = require("./../../src/Component");
...
var Timer = function (_Component) {
  ...
  function Timer(duration) {
     ...
     * @type {number}
     */
    _this.recurrence = options.recurrence || 0;

    /**
     * If reversible, the timer will go t o it's initial value after complete
     * @type {boolean}
     */
    _this.reversible = options.reversible || false;

    /**
     * Event fired when initialize
     * @type {function}
     */
    _this.eventInit = options.initialize;

    /**
     * Event fired when completed
     * @type {function}
     */
    _this.eventComplete = options.complete;
  ...
  _createClass(Timer, [{
    ...
    key: "stop",
    value: function stop(avoidCompleteEvent) {
