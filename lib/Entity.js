...
var Entity = function (_Element) {
    ...
    _createClass(Entity, [{
        ...
        value: function update() {
            ...
            this.velocity.y += (this.direction.y ? this.speed.y * this.direction.y * _Engine2.default.tick : 0) + (this.scene ? this.scene.gravity * _Engine2.default.tick : 0);
            if (this.velocity.y) {
