...
export default class Collision {
    ...
    resolveAll () {
        ...
        if (!entity.moving) {
            ...
            if (entity.props.x !== nextX) {
                this.resolveChain("x", this.shiftInX(entity, nextX));
            }

            if (entity.props.y !== nextY) {
            ...
            chains.slice(0, indexEntityBlocked + 1).reverse().forEach((chain, index, array) => {
                ...
                if (nextChain) {
                    if (axis === "x" && this.filterEntityByPositionY(nextChain.entity, chain.entity.props.y, chain.entity.props.y + chain.entity.props.height)) {
                        nextChain.entity.props.x  = chain.onLeft ? chain.entity.props.x + chain.entity.props.width : chain.entity.props.x - nextChain.entity.props.width;
                        ...
                        nextChain.entity.props.y  = chain.onTop ? chain.entity.props.y - nextChain.entity.props.height : chain.entity.props.y + chain.entity.props.height;
